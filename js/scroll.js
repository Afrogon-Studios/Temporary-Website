...
!(function () {
  ...
  function t() {
    if (document.body) {
      var t = document.body,
        ...
        i = t.scrollHeight;
      if (
        ((x = document.compatMode.indexOf("CSS") >= 0 ? n : t),
        (m = t),
        e(),
        (S = !0),
        top != self)
        ...
        if (
          ((n.style.height = "auto"), setTimeout(o, 10), x.offsetHeight <= r)
        ) {
    ...
    if (
      ...
      var u = e === document.body,
        a = function () {
          ...
          u
            ? window.scrollBy(s, o)
            : (s && (e.scrollLeft += s), o && (e.scrollTop += o)),
            t || n || (C = []),
  ...
  function v(e) {
    return e >= 1
      ...
      : 0 >= e
      ? 0
      : (1 == y.pulseNormalize && (y.pulseNormalize /= d(1)), d(e));
  }
  var m,
    g = {
      frameRate: 150,
